...
function instagramDeleter() {//  create a deleter loop function
   setTimeout(function () {//  call a 3s setTimeout when the loop is called
        ...
        setTimeout(function () { document.querySelector("body > div.RnEpo.Yx5HN > div > div > div > button.aOOlW.-Cab_").click(); }, 2000)         //  selector to click delete option
        setTimeout(function () { document.querySelector('body > div.RnEpo.Yx5HN > div > div > div.mt3GC > button.aOOlW.-Cab_').click(); }, 4000)         //  selector to click delete confirmation
